...
2. Clone the forked repository to your local machine.
   ```
   git clone https://github.com/username/MPW-Rent-Car.git
   ```
...
If you want to discuss something related to your contribution or the project in general, feel free to reach out to us via [Discussions](https://github.com/guanshiyin28/MPW-Rent-Car/discussions).

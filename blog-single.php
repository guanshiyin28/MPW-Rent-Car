...
<html lang="en">
  ...
  <body>
    ...
    <?php include 'components/navbar_blog-single.php'; // Menyertakan file navbar khusus halaman blog tunggal ?>
    <?php include 'components/content_blog-single.php'; // Menyertakan file konten khusus halaman blog tunggal ?>

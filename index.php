        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            <h1 class="mb-4">Cara cepat & mudah dalam menyewa Mobil   </h1>
			            ...
			            <div class="form-group">
	  					...
	  					<div class="col-md-8 d-flex align-items-center">
	  						<div class="services-wrap rounded-right w-100">
	  							<h3 class="heading-section mb-4">Cara Lebih Baik untuk Menyewa Mobil Sempurna Anda</h3>
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
    		...
    		<div class="row">
    				...
    				<div class="carousel-car owl-carousel">
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#">Mercedes Benz</a></h2>
                      ...
                      <p class="price ml-auto">IDR. 1.400.000 <span>/day</span></p>
    					...
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#">Range Rover Land</a></h2>
		    						<div class="d-flex mb-3">
                      ...
                      <p class="price ml-auto">IDR. 2.000.000<span>/day</span></p>
    					...
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#">Mclaren</a></h2>
		    						<div class="d-flex mb-3">
              ...
              <div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					<div class="img rounded d-flex align-items-end" style="background-image: url(images/car-5.jpeg);">
		    					</div>
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#">Daihatsu</a></h2>
		    						<div class="d-flex mb-3">
                      <span class="cat">New Sigra X 1.2 A/T</span>
      ...
      <div class="container">
        <div class="row no-gutters">
          ...
          <div class="col-md-6 wrap-about ftco-animate">
            <div class="heading-section heading-section-white pl-md-5">
              ...
              <p><a href="#" class="btn btn-primary py-3 px-4">Pilih Mobil</a></p>
            </div>
          </div>
        </div>
      </div>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Layanan Terbaru </h2>
          </div>
        </div>
				<div class="row">
					<div class="col-md-3">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/Alik.jpg)"></div>
                  <div class="text pt-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/Gusdean.jpg)"></div>
                  <div class="text pt-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/G.\ Raka.jpg)"></div>
                  <div class="text pt-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/mizzu.jpg)"></div>
                  <div class="text pt-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/syandi.jpg)"></div>
                  <div class="text pt-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5 bg-dark">
                  <div class="user-img mb-2" style="background-image: url(images/dedi.jpg)"></div>
                  <div class="text pt-4">
